...
const main = async () => {
  const country = [
    ...
    },
    {
      ...
      requirements:
        'Your dog will need a completed authorization form, a microchip or tattoo, a health certificate from your veterinarian.',
    ...
    },
    {
      ...
      requirements:
        'Your dog will need health certificate from your veterinarian, and vaccinated prior to departure.',
    ...
    },
    {
      ...
      requirements:
        'If you plan to travel to Kyrgyz keep in mind that pets must be accompanied by a veterinarian health certificate with the seal of the local Board of Health and not be issued over 10 days prior to arrival. Be advised, pets are not permitted in hotels.',
    ...
    },
    {
      ...
      requirements:
        'If you plan to travel with your pet to Mauritania, you will need to bring a current rabies vaccination certificate and a health certificate from the country of origin.',
    ...
    },
    {
      ...
      requirements:
        'If you would like to travel to Paraguay with your pet, you will need to obtain a health certificate from an authorized veterinarian and it must be legalized at a Paraguayan consulate in the US.',
    ...
    },
    {
      ...
      requirements:
        'If you would like to travel to Saudi Arabia with your pet, they are typically not allowed unless they are traveling for hunting, guarding, and/or guides for the disabled.',
    ...
    },
    {
      ...
      requirements:
        'First, pets should be accompanied by their owners or representatives. Second, your pet must be identified with a legible tattoo or microchip, and third, they need to have their animal health certificate. Be sure a copy of the health certificate is also completed in Spanish.',
    ...
    },
    {
      ...
      requirements:
        'Traveling to the U.S Virgin Islands with your pet is very easy! Pets just need to have an official health certificate stating that they did not originate from an area quarantined for rabies. Your pet must have been vaccinated for rabies within 6 months prior to the date of travel.',
